...
public class PagerSlidingTabStripExtends extends HorizontalScrollView {
	...
	private int mSelectedPosition;// 记录当前viewpager选中的position
	/*-----------------add end---------------------*/
	...
	public PagerSlidingTabStripExtends(Context context, AttributeSet attrs,
		...
		tabTextSize = a.getDimensionPixelSize(
				R.styleable.PagerSlidingTabStrip_pstsTabTextSize, tabTextSize);
		tabTextColor = a
				.getColor(R.styleable.PagerSlidingTabStrip_pstsTabTextColor,
						tabTextColor);
		selectedTabTextSize = a.getDimensionPixelSize(
				R.styleable.PagerSlidingTabStrip_pstsSelectedTabTextSize,
				selectedTabTextSize);
		selectedTabTextColor = a.getColor(
				R.styleable.PagerSlidingTabStrip_pstsSelectedTabTextColor,
